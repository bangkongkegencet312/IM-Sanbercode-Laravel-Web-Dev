...
<head>
  ...
  <title>Login SeoDash Book</title>
      ...
      <div class="d-flex align-items-center justify-content-center w-100">
        <div class="row justify-content-center w-100">
          <div class="col-md-8 col-lg-6 col-xxl-3">
            ...
            <div class="card shadow-lg border-0 " style="max-width: 100%; max-width: 500px; border-radius:15px;">
              <div class="card-body p-5">
                ...
                <form>
                  ...
                  <a href="/home" class="btn btn-primary w-100 py-8 fs-4 mb-4">Sign In</a>
                  <div class="d-flex align-items-center justify-content-center">
                    
                    <a class="text-primary fw-bold ms-2" href="/auth_register">Create an account</a>
                  </div>
                </form>
              </div>
            </div>
