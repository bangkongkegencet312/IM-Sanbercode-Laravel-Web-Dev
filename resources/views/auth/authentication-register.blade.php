...
<head>
  ...
  <title>Create Account SeoDash</title>
            ...
            <div class="card mb-0">
              <div class="card-body">
                ...
                <form>
                  ...
                  <a href="/auth_login" class="btn btn-primary w-100 py-8 fs-4 mb-4">Sign Up</a>
                  <div class="d-flex align-items-center justify-content-center">
                    <p class="fs-4 mb-0 fw-bold">Already have an Account?</p>
                    <a class="text-primary fw-bold ms-2" href="/auth_login">Sign In</a>
                  </div>
                </form>
              </div>
            </div>
