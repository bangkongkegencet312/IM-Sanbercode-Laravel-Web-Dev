...
<body>
    ...
    <?php   
        ...
        */
        ...
        echo "Panjang Kalimat pertama : " . strlen($first_sentence) . '<br>';
        echo "Jumlah Kata Kalimat pertama : " . str_word_count($first_sentence) . "<br><br>";

        echo "Kalimat kedua : " . $second_sentence . "<br>";
        echo "Panjang Kalimat kedua : " . strlen($second_sentence) . '<br>';
